...
TEST_SUITE("SOP1 format instructions test") {
    ...
    TEST_CASE("s_bcnt0_i32_b32") {
        ...
        Instruction instruction =
            Instruction(0, std::string("s_bcnt0_i32_b32"), {"s2", "s4"});
    ...
    TEST_CASE("s_bcnt0_i32_b64") {
        ...
        auto wavefront = Wavefront(nullptr, wfSize, sop1WfId, sgprnum, vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_bcnt0_i32_b64"), {"s2", "s[4:5]"});
    ...
    TEST_CASE("s_bcnt1_i32_b32}") {
        ...
        auto wavefront = Wavefront(nullptr, wfSize, sop1WfId, sgprnum, vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_bcnt1_i32_b32"), {"s6", "s1"});
    ...
    TEST_CASE("s_bcnt1_i32_b64}") {
        ...
        auto wavefront = Wavefront(nullptr, wfSize, sop1WfId, sgprnum, vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_bcnt1_i32_b64"), {"s2", "s[2:3]"});
    ...
    TEST_CASE("s_ff0_i32_b32") {
        ...
        auto wavefront = Wavefront(nullptr, wfSize, sop1WfId, sgprnum, vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_ff0_i32_b32"), {"s0", "s0"});
    ...
    TEST_CASE("s_ff0_i32_b64") {
        ...
        auto wavefront = Wavefront(nullptr, wfSize, sop1WfId, sgprnum, vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_ff0_i32_b64"), {"s0", "s[99:100]"});
    ...
    TEST_CASE("s_ff1_i32_b32") {
        ...
        auto wavefront = Wavefront(nullptr, wfSize, sop1WfId, sgprnum, vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_ff1_i32_b32"), {"s99", "s100"});
    ...
    TEST_CASE("s_flbit_i32_b32") {
        ...
        auto wavefront = Wavefront(nullptr, wfSize, sop1WfId, sgprnum, vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_flbit_i32_b32"), {"s0", "s0"});
    ...
    TEST_CASE("s_and_saveexec_b64") {
        ...
        auto wavefront = Wavefront(nullptr, wfSize, sop1WfId, sgprnum, vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_and_saveexec_b64"), {"s[0:1]", "vcc"});
    ...
    TEST_CASE("s_andn1_saveexec_b64") {
        ...
        auto wavefront = Wavefront(nullptr, wfSize, sop1WfId, sgprnum, vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_andn1_saveexec_b64"), {"s[0:1]", "vcc"});
