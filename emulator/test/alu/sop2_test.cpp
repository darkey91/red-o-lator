...
TEST_SUITE("SOP2 format instructions test") {
    ...
    TEST_CASE("s_absdiff_i32 - computes the absolute value of difference between two values.") {
        ...
        Instruction instruction =
            Instruction(0, std::string("s_absdiff_i32"), {"s6", "s10", "s11"});
    ...
    TEST_CASE("s_add_i32") {
        ...
        auto wavefront = Wavefront(nullptr, sop2WfSize, sop2WfId, sgprnum, sop2Vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_add_i32"), {"s0", "s10", "s11"});
    ...
    TEST_CASE("s_sub_i32") {
        ...
        auto wavefront = Wavefront(nullptr, sop2WfSize, sop2WfId, sgprnum, sop2Vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_sub_i32"), {"s0", "s10", "s11"});
    ...
    TEST_CASE("s_lshl_b32") {
        ...
        auto wavefront = Wavefront(nullptr, sop2WfSize, sop2WfId, sgprnum, sop2Vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_lshl_b32"), {"s0", "s1", "1"});
    ...
    TEST_CASE("s_and_b32") {
        ...
        auto wavefront = Wavefront(nullptr, sop2WfSize, sop2WfId, sgprnum, sop2Vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_and_b32"), {"s0", "s1", "s2"});
    ...
    TEST_CASE("s_bfe_u32") {
        ...
        auto wavefront = Wavefront(nullptr, sop2WfSize, sop2WfId, sgprnum, sop2Vgprnum);
        Instruction instruction =
            Instruction(0, std::string("s_bfe_u32"), {"s0", "s1", "s2"});
    ...
    TEST_CASE("s_mul_i32") {
        size_t sgprnum = 3;
        auto wavefront = Wavefront(nullptr, sop2WfSize, sop2WfId, sgprnum, sop2Vgprnum);
        Instruction instruction(0, std::string("s_mul_i32"), {"s0", "s1", "s2"});
