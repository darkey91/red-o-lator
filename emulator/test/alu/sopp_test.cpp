...
TEST_SUITE("SOPP format instructions test") {
    ...
    TEST_CASE("s_cbranch_scc1") {
        ...
        Instruction instruction = Instruction(0, std::string("s_cbranch_scc1"), {".L168_0"});
    ...
    TEST_CASE("s_cbranch_scc0") {
        size_t sgprnum = 2;
        auto wavefront = Wavefront(nullptr, soppWfSize, soppWfId, sgprnum, soppVgprnum);
        Instruction instruction = Instruction(0, std::string("s_cbranch_scc0"), {".L168_0"});
    ...
    TEST_CASE("s_cbranch_execz") {
        size_t sgprnum = 2;
        auto wavefront = Wavefront(nullptr, soppWfSize, soppWfId, sgprnum, soppVgprnum);
        Instruction instruction = Instruction(0, std::string("s_cbranch_execz"), {".L308_0"});
